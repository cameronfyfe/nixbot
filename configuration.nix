...

{
  imports = [
    ...
    # Systemd jobs split into dedicated module files.
    ./systemd-jobs/openclaw-backup-sync.nix
  ];
  ...
  security.sudo.extraRules = [
    {
      ...
      commands = [
        ...
        {
          command = "/nix/var/nix/profiles/system/sw/bin/nixos-rebuild";
          options = [ "NOPASSWD" ];
        }
      ];
    }
  ...
  services.displayManager.autoLogin.user = "nixbot";
  ...
  # Use a local Codex derivation built from GitHub releases.
  nixpkgs.overlays = [
